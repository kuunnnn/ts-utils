...
exports.safeStringCompare = exports.safeStringCompare2 = void 0;
/**
 * 时间恒定的比较函数
 * @param {string} a
 * @param {string} b
 * @return {boolean}
 */
function safeStringCompare2(a, b) {
...
exports.safeStringCompare2 = safeStringCompare2;
/**
 * 恒定时间的比较算法
 ...
 * @return {Boolean}
 */
function safeStringCompare(cipher1, cipher2) {
    let right = 0;
    let wrong = 0;
